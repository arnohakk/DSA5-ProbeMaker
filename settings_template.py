...
heros = ["res/Friedo Firlefanz.json", "res/Maaso.json", "res/Wanda Weinreb.json","res/Garonn Regentag.json", "res/Baduin Nepolemo Kalman Falconieri.json", "res/Wanda Weinreb.json"]
