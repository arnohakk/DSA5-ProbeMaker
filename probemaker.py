...
class Hero:
    ...
    def __init__(self, file, show_values=False):
        ...
        self.tal['Faehrtensuchen'] = ['MU', 'IN', 'GE', talents['TAL_22'] if 'TAL_22' in talents else 0]
        self.tal['Fesseln'] = ['KL', 'FF', 'KK', talents['TAL_23'] if 'TAL_23' in talents else 0]
        self.tal['Fischen u Angeln'] = ['FF', 'GE', 'KO', talents['TAL_24'] if 'TAL_24' in talents else 0]
        self.tal['Orientierung'] = ['KL', 'IN', 'IN', talents['TAL_25'] if 'TAL_25' in talents else 0]
        self.tal['Pflanzenkunde'] = ['KL', 'FF', 'KO', talents['TAL_26'] if 'TAL_26' in talents else 0]
        self.tal['Tierkunde'] = ['MU', 'MU', 'CH', talents['TAL_27'] if 'TAL_27' in talents else 0]
        self.tal['Wildnisleben'] = ['MU', 'GE', 'KO', talents['TAL_28'] if 'TAL_28' in talents else 0]

        self.tal['Brett- u Gluecksspiel'] = ['KL', 'KL', 'IN', talents['TAL_29'] if 'TAL_29' in talents else 0]
        self.tal['Geographie'] = ['KL', 'KL', 'IN', talents['TAL_30'] if 'TAL_30' in talents else 0]
        self.tal['Geschichtswissen'] = ['KL', 'KL', 'IN', talents['TAL_31'] if 'TAL_31' in talents else 0]
        self.tal['Goetter u Kulte'] = ['KL', 'KL', 'IN', talents['TAL_32'] if 'TAL_32' in talents else 0]
        self.tal['Kriegskunst'] = ['MU', 'KL', 'IN', talents['TAL_33'] if 'TAL_33' in talents else 0]
        self.tal['Magiekunde'] = ['KL', 'KL', 'IN', talents['TAL_34'] if 'TAL_34' in talents else 0]
        self.tal['Mechanik'] = ['KL', 'KL', 'FF', talents['TAL_35'] if 'TAL_35' in talents else 0]
        self.tal['Rechnen'] = ['KL', 'KL', 'IN', talents['TAL_36'] if 'TAL_36' in talents else 0]
